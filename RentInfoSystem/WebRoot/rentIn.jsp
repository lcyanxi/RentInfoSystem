...
<div class="mega_nav">
	 <div class="container">
		 ...
		 <ul class="megamenu skyblue">
			    ...
			    <li><a class="color2" href="showRentInData.action">求租结果</a></li>	
...
<div class="container">
	  <ol class="breadcrumb">
		  ...
		  <li class="active">求租申请</li>
		 </ol>
	 <div class="registration">
		 <div class="registration_left">
			 <h2>想要租房吗? <span> 那就先填一张表吧 </span></h2>
			 <h2> <c:if test="${result!=null }"><a href="showRentInData.action"> ${result}现在去看看吧</a></c:if> </h2>
			 <!-- [if IE] 
			 ...
			 <!-- Form -->
				<form id="registration_form" action="rentIn.action" method="post">
				   <div>
						<label>
						<input type="radio" name="rentIn.rent_in_type" id="rentTpye" value="整租" checked>整租
			            <input type="radio" name="rentIn.rent_in_type" id="rentTpye" value="合租" />合租						
						</label>
					</div> 
					<div>
						<label>
							<input placeholder="标题" type="text" name="rentIn.title" tabindex="4" required>
						</label>
					</div>
					<div>
						<label>
							<input placeholder="期望租金" type="text" name="rentIn.money" tabindex="4" required>
						</label>
					</div>						
					<div>
						<label>
							<input placeholder="期望面积" type="text" name="rentIn.area" tabindex="4" required>
						</label>
					</div>	
					<div>
						<label>
							<input placeholder="期望地点" type="text" name="rentIn.address" tabindex="4" required>
						</label>
					</div>		
						<div>
						<label>
							<input   type="checkbox" name="rentIn.equipment" value="空调" checked />空调
			                <input   type="checkbox" name="rentIn.equipment" value="厨房"  />厨房
			               <input   type="checkbox" name="rentIn.equipment" value="电视"  />电视
			               <input  type="checkbox" name="rentIn.equipment" value="卫生间"  />卫生间
			               <input  type="checkbox" name="rentIn.equipment" value="宽带" />宽带
			               <input  type="checkbox" name="rentIn.equipment" value="阳台"  />阳台
						</label>
					</div>		
						<div>
						<label>
							<input placeholder="额外说明:" type="text" name="rentIn.detail" tabindex="3" required>
						</label>
					</div>				
					<div>
